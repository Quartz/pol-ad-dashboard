...
<div className={cx( 'tools' )}>
  ...
  <li><a href="https://dashboard-backend.qz.ai/ads/swing_state_ads">Swing-state ads (persuasive ads?)</a></li>
  <h4>Advertisers</h4>
  <ul>
    ...
    <li><a href="https://dashboard-backend.qz.ai/ads/pivot/advertiser?time_unit=month&time_count=3&first_seen=1">New past 3 months</a></li>
    <li><a href="https://dashboard-backend.qz.ai/ads/pivot/advertiser?time_unit=month&time_count=3">Seen past 3 months</a></li>
  ...
  <ul>
    ...
    <li><a href="https://dashboard-backend.qz.ai/ads/pivot/paid_for_by?time_unit=month&time_count=3&first_seen=1">New past 3 months</a></li>
    <li><a href="https://dashboard-backend.qz.ai/ads/pivot/paid_for_by?time_unit=month&time_count=3">Seen past 3 months</a></li>
  ...
  <ul>
    ...
    <li><a href="https://dashboard-backend.qz.ai/ads/pivot/segments?time_unit=month&time_count=3&first_seen=1">New past 3 months</a></li>
    <li><a href="https://dashboard-backend.qz.ai/ads/pivot/segments?time_unit=month&time_count=3">Seen past 3 months</a></li>
